FactoryGirl.define do
  factory :story do
    ...
    factory :story_with_uploaded_wrong_cover do #image with wrong dimensions - use this child factory when making a post/patch request with attributes_for
      cover { Rack::Test::UploadedFile.new("#{Rails.root}/spec/support/fixtures/images/test_user_avatar_400.png", "image/png") } #issues multi-part request
    end
